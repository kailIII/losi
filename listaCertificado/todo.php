    ...
    foreach ($oExpedientes as $llave => $aExpedientes) {
        ...
        if ($nuevo) {
            ...
            if ($oExpHistoria) {
                ...
                $dias = $oExpHistoria[0]->getDiferencia();
            } else {
...
//            $dias = $diaTabla->diff($diaHoy);
        ...
        $total += $aExpedientes->getImporte(); ?></td>
                ...
                <?php if ((($dias * 100) / 7) >= 50) $progreso = 'progress-bar-warning'; ?>
                <?php if ((($dias * 100) / 7) >= 85) $progreso = 'progress-bar-danger'; ?>
                ...
                <td>
                    <div class="progress bajocinco">
                        <div class="progress-bar <?php echo $progreso; ?>" style="width: <?php echo ($dias * 100) / 7; ?>%;"
                             title="<?php echo $diaTabla->format('d/m/Y'); ?>" ></div>
                        <div class="progress-bar progress-bar-info" style="width: <?php echo 100 - ($dias * 100) / 7; ?>%;"
                             title="<?php echo $diaTabla->format('d/m/Y'); ?>" ></div>
                    </div>
