...
$html = file_get_html('http://www.vialidad.gov.ar/mesa_entrada/mesa_entrada.php');
        ...
        $html = file_get_html('http://www.vialidad.gov.ar/mesa_entrada/mesa_entrada.php', false, $context);
        
//        echo file_get_html('http://www.vialidad.gov.ar/mesa_entrada/mesa_entrada.php', false, $context)->plaintext;
        $prueba = file_get_html('http://www.vialidad.gov.ar/mesa_entrada/mesa_entrada.php', false, $context)->plaintext;
        $tema = strpos($prueba, 'Tema: ');
        $fecha = strpos($prueba, 'Fecha de alta: ');
        echo "<br /> Tema-> ".substr($prueba, $tema+6, $fecha-$tema-6);
        
//        $prueba = explode(":",$prueba);
//        var_dump($prueba);
//        foreach ($prueba as $i => $pp) {
//            echo $pp[$i] . "<br>";
//        }
