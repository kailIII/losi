    ...
    <body>
        ...
        <div class="container">
            <form class="form-horizontal">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <label class="label-success label">Importe Obra</label>
                        <input class="form-control small" name="importe" id="importe" value="" type="text" />
                    </div>
                    <!--<div class="col-lg-1"></div>-->
                    <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <input type="button" value="Guardar" id="guardar" class="btn btn-large btn-block btn-primary" onclick="guardarDatos();" />
                    </div>
